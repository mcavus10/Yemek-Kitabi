...
import com.muhammedcavus.yemekkitabi.adapter.TarifAdapter
import com.muhammedcavus.yemekkitabi.databinding.FragmentListeBinding
...
// onDestroyView.
    ...
    fun handleResponse(tarifler : List<Tarif>){
